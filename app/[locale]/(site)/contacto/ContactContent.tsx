            ...
            <div className="mt-12 space-y-6">
              ...
              <dl className="space-y-4">
                <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-5">
                  <dt className="font-medium text-[var(--text-primary)]">{t("faq1Q")}</dt>
                  <dd className="mt-2 text-sm text-[var(--text-secondary)]">{t("faq1A")}</dd>
                </div>
                <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-5">
                  <dt className="font-medium text-[var(--text-primary)]">{t("faq2Q")}</dt>
                  <dd className="mt-2 text-sm text-[var(--text-secondary)]">{t("faq2A")}</dd>
                </div>
                <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-5">
                  <dt className="font-medium text-[var(--text-primary)]">{t("faq3Q")}</dt>
                  <dd className="mt-2 text-sm text-[var(--text-secondary)]">{t("faq3A")}</dd>
                </div>
              </dl>
            </div>
          </AnimateOnScroll>
