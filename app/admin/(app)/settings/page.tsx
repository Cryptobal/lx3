        ...
        <div className="p-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              ...
              <div className="px-3 py-2 text-sm bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg text-zinc-900 dark:text-zinc-100">
                {session?.user?.name || "—"}
              </div>
            </div>
            <div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <code className="px-1.5 py-0.5 text-xs font-mono bg-zinc-200 dark:bg-zinc-700 rounded text-zinc-700 dark:text-zinc-300">
                      NOTIFICATION_EMAIL
                    </code>
