...
export function Footer() {
  ...
  const socialColors: Record<string, string> = {
    ...
    facebook: "bg-[#1877F2] hover:bg-[#1877F2]/80",
    x: "bg-[#0F1419] hover:bg-[#0F1419]/80",
  };
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Facebook"
                className={`${baseSocialClass} ${socialColors.facebook}`}
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="X"
                className={`${baseSocialClass} ${socialColors.x}`}
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
