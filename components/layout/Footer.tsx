...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 bg-[#0F1729]">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-6 flex gap-4">
              <a
                href="https://www.instagram.com/lx3.ai"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/40 transition-colors hover:bg-white/10 hover:text-white"
              >
              ...
              <a
                href="https://www.linkedin.com/company/lx3ai"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/40 transition-colors hover:bg-white/10 hover:text-white"
              ...
              <a
                href="https://www.facebook.com/lx3ai"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/40 transition-colors hover:bg-white/10 hover:text-white"
