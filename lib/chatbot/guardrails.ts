...
const COMPETITOR_PATTERNS = [
  /\b(thoughtworks|globant|endava|epam|accenture|deloitte)\b/i,
  /\b(wipro|infosys|tata|cognizant|neoris|bairesdev)\b/i,
  /\b(webflow agency|wordpress agency|agencia digital|agencia web)\b/i,
  /\b(freelancer|freelancers|upwork|fiverr|toptal)\b/i,
...
const REDIRECT_MESSAGES: Record<OffTopicCategory, Record<string, string>> = {
  ...
  competitor: {
    en: 'I appreciate the question, but I prefer to focus on what makes LX3 unique rather than commenting on other firms. Our strength lies in our methodology — Discovery, Design, Development, Evolution — which ensures alignment between software capabilities and your specific business outcomes. Would you like to explore how that applies to your situation?',
    es: 'Agradezco la pregunta, pero prefiero enfocarme en lo que hace unico a LX3 en lugar de comentar sobre otras firmas. Nuestra fortaleza esta en nuestra metodologia — Discovery, Design, Development, Evolution — que asegura alineacion entre las capacidades de software y sus resultados de negocio especificos. Le gustaria explorar como eso se aplica a su situacion?',
  },
  technical: {
    en: 'That is an excellent technical question. The specific technology decisions are made during our Design phase, where we evaluate the best tools for each unique situation. I would rather focus on understanding your business needs first — the technical architecture follows from there. Shall we continue exploring your current challenges?',
    es: 'Esa es una excelente pregunta tecnica. Las decisiones de tecnologia especifica se toman durante nuestra fase de Design, donde evaluamos las mejores herramientas para cada situacion unica. Preferiria enfocarme primero en entender sus necesidades de negocio — la arquitectura tecnica se deriva de ahi. Continuamos explorando sus desafios actuales?',
  },
  off_topic: {
    en: 'I appreciate your curiosity! However, my expertise is focused on software, AI, and business transformation. Let me bring us back — we were exploring some interesting opportunities for your organization. Shall we continue with that?',
    es: 'Aprecio su curiosidad! Sin embargo, mi experiencia se enfoca en software, IA y transformacion de negocios. Permitame retomar el hilo — estabamos explorando algunas oportunidades interesantes para su organizacion. Continuamos con eso?',
  },
};
